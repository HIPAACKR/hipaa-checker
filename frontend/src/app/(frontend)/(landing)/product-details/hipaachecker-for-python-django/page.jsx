...
export async function generateMetadata() {
  const product = productsData.find((p) => p.slug === 'hipaachecker-for-python-django');
  return createMetadata(
    `${product.title} | HIPAAChecker Product Details`,
    product.description,
    `/product-details/hipaachecker-for-python-django`
  );
}
...
const ProductDetails = () => {
  return (
    <div className='productDetails'>
      <EyeCatch
        param='hipaachecker-for-python-django'
      ...
      <div className='productDetails__container-background'>
        ...
        <div className='productDetails__container'>
          <div className='productDetails__content'>
            <div>
              <div className='productDetails__container__title'>Unified PyPortal is here</div>
              <Text
                color='neutral-500'
                size='fs-18'
              >
                <strong>PyPortal</strong> is lightweight, cloud-native, and can check real-world
                Django webapp vulnerabilities with a single click using our website. Upload an
                codebase or link your git and see the HIPAA reports instantly.
              </Text>
            </div>
            <Image
              src='/images/common/python-details.svg'
      ...
      <div className='productDetails__check-feature'>
        ...
        <div className='productDetails__youtube__heading'>
          <Heading
            title={'See How our PyPortal Works Below'}
            type='h2'
            color='neutral-800'
            align='center'
          />
        ...
        <iframe
          ...
          width='1041'
          height='571'
          src="https://www.youtube.com/embed/wGXoJCadotk"
