...
export async function generateMetadata() {
  const product = productsData.find((p) => p.slug === 'hipaachecker-for-spring-boot');
  return createMetadata(
    `${product.title} | HIPAAChecker Product Details`,
    product.description,
    `/product-details/hipaachecker-for-spring-boot`
  );
}
...
const ProductDetails = () => {
  return (
    <div className='productDetails'>
      <EyeCatch
        param='hipaachecker-for-spring-boot'
      ...
      <div className='productDetails__container-background'>
        ...
        <div className='productDetails__container'>
          <div className='productDetails__content'>
            <div>
              <div className='productDetails__container__title'>Unified JavaPortal is here</div>
              <Text
                color='neutral-500'
                size='fs-18'
              >
                <strong>JavaPortal</strong> is lightweight, cloud-native, and can check real-world
                Spring Boot on Rails webapp vulnerabilities with a single click using our website. Upload
                an codebase or link your git and see the HIPAA reports instantly.
              </Text>
            </div>
            <Image
              src='/images/common/spring_detail.jpg'
      ...
      <div className='productDetails__check-feature'>
        ...
        <div className='productDetails__youtube__heading'>
          <Heading
            title={'See How Our JavaPortal Works Below'}
            type='h2'
            color='neutral-800'
            align='center'
          />
