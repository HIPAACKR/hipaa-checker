...
export async function generateMetadata() {
  const product = productsData.find((p) => p.slug === 'hipaachecker-for-dot-net');
  return createMetadata(
    `${product.title} | HIPAAChecker Product Details`,
    product.description,
    `/product-details/hipaachecker-for-dot-net`
  );
}
...
const ProductDetails = () => {
  return (
    <div className='productDetails'>
      <EyeCatch
        param='hipaachecker-for-dot-net'
      ...
      <div className='productDetails__container-background'>
        ...
        <div className='productDetails__container'>
          <div className='productDetails__content'>
            <div>
              <div className='productDetails__container__title'>Unified DotNETPortal is here</div>
              <Text
                color='neutral-500'
                size='fs-18'
              >
                <strong>DotNETPortal</strong> is lightweight, cloud-native, and can check real-world
                .NET webapp vulnerabilities with a single click using our website. Upload an
                codebase or link your git and see the HIPAA reports instantly.
              </Text>
            </div>
            <Image
              src='/images/common/dotnet_detail.jpg'
      ...
      <div className='productDetails__check-feature'>
        ...
        <div className='productDetails__youtube__heading'>
          <Heading
            title={'See How our DotNETPortal Works Below'}
            type='h2'
            color='neutral-800'
            align='center'
          />
        ...
        <iframe
          ...
          width='1041'
          height='571'
          src="https://www.youtube.com/embed/zCKsHtb6ujM"
