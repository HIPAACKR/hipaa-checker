...
export async function generateMetadata() {
  const product = productsData.find((p) => p.slug === 'hipaachecker-for-php-laravel');
  return createMetadata(
    `${product.title} | HIPAAChecker Product Details`,
    product.description,
    `/product-details/hipaachecker-for-php-laravel`
  );
}
...
const ProductDetails = () => {
  return (
    <div className='productDetails'>
      <EyeCatch
        param='hipaachecker-for-php-laravel'
      ...
      <div className='productDetails__container-background'>
        ...
        <div className='productDetails__container'>
          <div className='productDetails__content'>
            <div>
              <div className='productDetails__container__title'>Unified PHPPortal is here</div>
              <Text
                color='neutral-500'
                size='fs-18'
              >
                <strong>PHPPortal</strong> is lightweight, cloud-native, and can check real-world
                PHP Laravel web app vulnerabilities with a single click. Upload a codebase or link
                your git and see the HIPAA reports instantly.
              </Text>
            </div>
            <Image
              src='/images/common/php-details.svg'
      ...
      <div className='productDetails__check-feature'>
        ...
        <div className='productDetails__youtube__heading'>
          <Heading
            title={'See How Our PHPPortal Works Below'}
            type='h2'
            color='neutral-800'
            align='center'
          />
        ...
        <iframe
          ...
          width='1041'
          height='571'
          src="https://www.youtube.com/embed/rxXkDcNIbg0"
